...
public class TodoAppModule : AbpModule
{
    ...
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        if (!hostingEnvironment.IsDevelopment())
        {
            ...
            {
                serverBuilder.AddProductionEncryptionAndSigningCertificate("openiddict.pfx", "9097f482-1523-49b5-bf5d-c28dd24e5242");
            });
        }
    ...
    {
        context.Services.AddMapperlyObjectMapper<TodoAppModule>();
    }
