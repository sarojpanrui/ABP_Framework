...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p c27c27e0-dbc1-45d8-8d06-f09f223c1dff
```

> `c27c27e0-dbc1-45d8-8d06-f09f223c1dff` is the password of the certificate, you can change it to any password you want.
